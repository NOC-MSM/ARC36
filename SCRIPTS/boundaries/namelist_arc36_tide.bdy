...
!  grid information
!------------------------------------------------------------------------------
   sn_src_hgr = '/work/scratch-pw5/benbar/ARC36/NPD025/domain_cfg_eORCA025.nc'
   sn_src_zgr = '/work/scratch-pw5/benbar/ARC36/NPD025/domain_cfg_eORCA025.nc'
   sn_dst_hgr = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/domain_cfg_arc36.nc'     ! Expects vars found in domain_cfg.nc
   sn_dst_zgr = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/domain_cfg_arc36.nc'     ! Expects vars: {e3u,e3v,e3w,e3t,nav_lat,nav_lon,mbathy}
   sn_src_msk = '/work/scratch-pw5/benbar/ARC36/NPD025/mesh_mask_eORCA025.nc'
   sn_bathy   = '/work/scratch-pw5/benbar/ARC36/Domain/bathy_arc36.nc'    ! dst bathymetry w/o time dimension
...
!------------------------------------------------------------------------------
   ...
   sn_fn      = 'arc36_tide'             ! prefix for output files
...
!------------------------------------------------------------------------------
    ...
    cn_mask_file   = '/work/scratch-pw5/benbar/ARC36/Domain/pybdy_mask_arc36.nc'            !  name of mask file
...
!------------------------------------------------------------------------------
    ...
    sn_tide_fes        = '/gws/ssde/j25a/nemo/vol1/benbar/FES2014/'

!------------------------------------------------------------------------------
!  Time information for output
!------------------------------------------------------------------------------
    sn_date_start   = '2008-05-01'    !  dst output date start YYYY-MM-DD
    sn_date_end     = '2008-12-01'    !  dst output date end YYYY-MM-DD
