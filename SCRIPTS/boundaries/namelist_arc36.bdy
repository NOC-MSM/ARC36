...
!  grid information
!------------------------------------------------------------------------------
   sn_src_hgr = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/NPD025/domain_cfg_eORCA025.nc'
   sn_src_zgr = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/NPD025/domain_cfg_eORCA025.nc'
   sn_dst_hgr = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/Domain/domain_cfg_arc36.nc'     ! Expects vars found in domain_cfg.nc
   sn_dst_zgr = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/Domain/domain_cfg_arc36.nc'     ! Expects vars: {e3u,e3v,e3w,e3t,nav_lat,nav_lon,mbathy}
   sn_src_msk = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/NPD025/mesh_mask_eORCA025.nc'
   sn_bathy   = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/Domain/bathy_arc36.nc'    ! dst bathymetry w/o time dimension
...
!  I/O
!------------------------------------------------------------------------------
   sn_src_dir = './src_data_arc36.ncml' ! src_files/'
   sn_dst_dir = '/work/scratch-pw5/benbar/ARC36/BDY_Output'
   sn_fn      = 'arc36'             ! prefix for output files
   nn_fv      = -1e20                 !  set fill value for output files
   nn_src_time_adj = 0                ! src time adjustment
   sn_dst_metainfo = 'arc36 bdy'  ! history info
...
!------------------------------------------------------------------------------
    ...
    cn_mask_file   = '/gws/ssde/j25a/nemo/vol1/benbar/ARC36/Domain/pybdy_mask_arc36.nc'            !  name of mask file
...
!------------------------------------------------------------------------------
    sn_date_start   = '2009-12-01'    !  dst output date start YYYY-MM-DD
    sn_date_end     = '2010-01-01'    !  dst output date end YYYY-MM-DD
...
!------------------------------------------------------------------------------
    ...
    rn_r0   = 0.08                 !  decorrelation distance use in gauss
