...
CONTAINS
   ...
   SUBROUTINE ice_dyn_rhg_eap( kt, Kmm, pstress1_i, pstress2_i, pstress12_i, pshear_i, pdivu_i, pdelta_i, paniso_11, paniso_12, prdg_conv )
      ...
      REAL(wp), DIMENSION(jpi,jpj) ::   zdragx_oi, zdragy_oi            ! ice-ocean drags at U-V points
      !
   ...
   SUBROUTINE rhg_cvg_eap( kt, kiter, kitermax, pu, pv, pub, pvb, pmsk15 )
      ...
      ELSE
         ...
         ELSE                   ! error averaged over the domain
            ...
            END_2D
            ztmp(:) = glob_2Dsum( 'icedyn_rhg_eap', zres )
...
!9 aug 2024 Stef use clems limits
